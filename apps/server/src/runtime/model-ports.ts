import { OpenAiCampaignSpineAdapter, OpenAiDirectorAdapter, OpenAiNarratorAdapter, type AgentConfig } from "@third-chair/agents";
...
export function createLiveModelPorts(config: AgentConfig, sourcePack: SourcePackService) {
  return {
    ...
    campaignSpine: new OpenAiCampaignSpineAdapter({ config, sourcePack }),
  };
}
