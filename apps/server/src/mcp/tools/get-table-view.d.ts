...
export declare const getTableViewDescriptor: {
    readonly name: "get_table_view";
    readonly description: "Use this when you need the current player-safe table state.";
    readonly inputSchema: {
        readonly campaignId: import("zod").ZodString;
    };
...
export declare function getTableView(deps: {
    campaigns: CampaignRepository;
}, input: {
    campaignId: string;
}): ToolResult;
//# sourceMappingURL=get-table-view.d.ts.map