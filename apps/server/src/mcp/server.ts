import type { CampaignRepository, CheckpointRepository, TurnRepository } from "@third-chair/storage";
...
type ServerDependencies = { campaigns: CampaignRepository; turns: TurnRepository; engine: TurnEngine; checkpoints?: CheckpointRepository; sourcePack?: SourcePackService; campaignCreator?: CampaignBuilder };
...
export function createMcpServer(deps: ServerDependencies): McpServer {
  return { tools: [listCampaignsDescriptor, createCampaignDescriptor, getTableViewDescriptor, advanceGameDescriptor, answerRulesDescriptor, recallKnownLoreDescriptor, createCheckpointDescriptor, rewindToCheckpointDescriptor, renderTableDescriptor], async invoke(name, input) {
