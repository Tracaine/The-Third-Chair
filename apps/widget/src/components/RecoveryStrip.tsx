...
export function RecoveryStrip({ view, lastMutationId, serverStatus, controls }: RecoveryStripProps) {
  const recoveryLabel = view.recoveryStatus === "NONE" ? "Recovered and current" : "Narration recovery required";
  return (
    <footer className="table-footer">
      {controls}
      <div className="recovery-strip" aria-label="Table recovery status">
