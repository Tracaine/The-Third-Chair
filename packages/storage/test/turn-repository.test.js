...
import { createCampaignRepository, createTurnRepository, openCampaignDatabase, } from "@third-chair/storage";
import { beginInput, checkResolution, committedCandidate, createTempDatabase, decision, resolutionPlan, seedCampaign, turnProposal, worldState, } from "./fixtures.js";
...
describe("turn reservation and stages", () => {
    it("is idempotent for the same request and rejects a reused key with different input", () => {
        ...
        try {
            ...
            expect(() => repo.beginTurn({ ...input, inputHash: "different" })).toThrow("IDEMPOTENCY_KEY_REUSED_WITH_DIFFERENT_INPUT");
    ...
    it("enforces legal monotonic stage transitions and keeps forward payloads immutable", () => {
        ...
        try {
            ...
            expect(() => repo.persistResolutions(turnId, [checkResolution("stages_early", earlyPlan.id)], 1)).toThrow("ILLEGAL_TURN_TRANSITION");
...
//# sourceMappingURL=turn-repository.test.js.map