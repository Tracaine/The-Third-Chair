...
export const ravenIntent: ActorIntent = {
  ...billIntent,
  seat: "RAVEN",
  actorId: "test_actor_raven",
};

export const bothDecision: DecisionRequest = {
  id: decisionId,
  stateVersion: 0,
  mode: "EXPLORATION",
  owner: "BOTH",
...
export const ravenDecision: DecisionRequest = {
  ...bothDecision,
  id: "test_decision_raven",
  owner: "RAVEN",
};

const actor = (controller: "BILL" | "RAVEN", name: string) => ({
  controller,
  name,
  level: 1,
